    ...
    chapters: [
        {
            ...
            hidden: false,
            title: '',
            legend: '<strong>Violence across Sudan since April</strong> (ACLED, August 4, 2023)<br><span class="dot7"></span> Armed clashes, explosions, and attacks<br><span class="dot8"></span> Sexual violence, excessive force against protesters, and abductions<br><span class="dot9"></span> Violence against civilians, looting, mob violence<br>',
            image: '',
          caption: '',
            description: 
