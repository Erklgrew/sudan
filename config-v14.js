    ...
    chapters: [
        {
            ...
            hidden: false,
            title: '',
            legend: '<strong>Violence across Sudan</strong> (ACLED)<br><span class="dot"></span> Armed clashes, explosions, and attacks<br><span class="dot2"></span> Sexual violence, excessive force against protesters, and abductions<br><span class="dot3"></span> Violence against civilians, looting, mob violence<br>',
            image: '',
          caption: '',
            description: 
