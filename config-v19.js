    ...
    chapters: [
        {
            ...
            hidden: false,
            title: '',
            legend: '<strong>Violence across Sudan since April 15</strong> (ACLED, August 4, 2023)<br><span class="dot7"></span> Armed clashes, explosions, and attacks<br><span class="dot8"></span> Sexual violence, excessive force against protesters, and abductions<br><span class="dot9"></span> Violence against civilians, looting, mob violence<br>',
            image: '',
          caption: '',
            description: 
'The Sudanese Armed Forces and Rapid Support Forces have been fighting since April 15th, leading to widespread displacement within Sudan and beyond.',
        ...
        },
      {
            ...
            hidden: false,
            title: '',
            legend: '<strong>Internally displaced persons</strong> (IOM, August 6, 2023)<br><span class="dot4"></span> <50,000<br><span class="dot5"></span> 50,000-200,000<br><span class="dot6"></span> >200,000<br>',
            image: '',
          caption: '',
            description: 
'Since the war began, more than 3.5 million Sudanese have been displaced and more than 800,000 have fled the country, with reports of targeted ethnic killings in Greater Darfur and Khartoum. ',
          location: {
            ...
            hidden: false,
            title: '',
            legend: '<strong>Near term food insecurity, June–September</strong> (FEWS Net, August 2, 2023)<br><span class="dot"></span> Stressed<br><span class="dot2"></span> Crisis<br><span class="dot3"></span> Emergency<br>',
            image: '',
          caption: '',
            description: 
